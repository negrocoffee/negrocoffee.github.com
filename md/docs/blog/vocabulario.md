...
- Abecedario
    ...
    - ## E
        - ### EBF
        - ### endospermo
            - Las paredes gruesas de la célula compuestas de hemicelulosa, que sirve como almacenamiento de alimento. Es lo que la mayoría reconocemos como el "grano de café", menos el embrión.
        - ### erosión
            - La acción superficial que remueve "soluto" y/o materia no disuelta y la transporta hacia la taza en una preparación de café.
        - ### espresso
            - italiano
            ...
            - corto
                - dosis
                - rendimiento
        - ### evaluación del grano verde - protocolo
            - [protocolo de evaluación del grano verde de la sca](https://sca.coffee/research/protocols-best-practices)
        - ### extracción 
    ...
    - ## M
        ...
        - ### molino de rodillo
            ...
            - Pueden tener varias etapas para ir disiminuyendo el tamaño de las partículas de café molidas de forma más homogénea. Además pueden enfriar cada uno de los rodillos y aislar todo el proceso de molienda del ambiente, cumpliendo con normas estrictas de sanidad. El tamaño de molienda deseada puede ser casi infinito.
            - img:
                - ![](https://storage.googleapis.com/negro.coffee/cafe/industria/Screenshot%202020-05-16%20at%2016.05.38.png)
    ...
    - ## P
        - ### parámetros de preparación
            ...
            - 
        - ### película plateada
            - capa delgada que rodea el "endospermo"
        - ### pod
            - sistema de praparación de una sola taza utilizando bolsas de papel, tipo té. Se pueden preparar en una máquina de espresso convencional con una canastilla especial para contenerlas.
        - ### pre-porcionar
            - La práctica de medir con anterioridad las dosis de preparación.
    ...
    - ## R
        - ### refractómetro
            - 
        - ### rendimiento
        - ### retención de molienda
            - La suma total de todas las [partículas de café molido](((N7sWZiPT5))) contenidas al interior de un "molino de café ".
        - ### roca
    ...
    - ## S
        ...
        - ### solvente
            - El componente líquido de una "solución", disuelve el "soluto".
            
        - ### soluto
            - el componente sólido de una "solución", disuelto por el "solvente"
            
        - ### [[Sub-Extracción]]
            - definición::
                - Estado de la [[Preparación]] de una bebida de café. Se caracteriza por no haber realizado una #café/preparación/extracción mínima de los #solidos_solubles para conseguir una bebida #balanceada.
            - enlaces::
                - "Un sabor agrio en una bebida de café es muestra de sub-extracción."
                - "En el sentido más simple, la extracción es una función del tiempo de preparación de la bebida de café. Por lo tanto, podemos decir que una bebida que tenga sabor agrio, es una bebida que no ha tenido el tiempo suficiente de preparación y, por esto, es una bebida subextraída. "
                - [[Agrio]] [[Agrioso]] [[Agrie]]
            - traducción::
                - #under-extracted 
            
        - ### superautomática
            - máquina que prepara una bebida completa de café con un solo comando.
